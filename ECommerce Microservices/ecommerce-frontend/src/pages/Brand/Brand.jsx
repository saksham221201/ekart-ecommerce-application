...
import { getProductsByBrand } from "../../redux/reducers/slices/productByBrand";
...
function Category({ showSuccessAlert, setErrorMessage }) {
  ...
  }, [dispatch, brand, userId]);

  const products = useSelector((state) => state.productByBrand);
    ...
    <>
      <div className="container mt-2">
        <div className="d-flex justify-content-between align-items-center">
          ...
          <h2 className="text-white text-center my-2 brand">
            {searchQuery ? `You Searched: ${searchQuery}` : `Brand: ${brand}`}
          </h2>
          <div>
            <input
              type="text"
